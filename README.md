Este es un proyecto para la asignatura de Fundamentos de Programación de la UNED. Está escrito en C±, un lenguaje creado por la UNED y constituido por un subconjunto de los lenguajes C y C++. 
